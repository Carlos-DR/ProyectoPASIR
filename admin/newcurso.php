    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item">
            <a class="nav-link" href="admincursos.php">Cancelar</a>
          </li>
        </ul>
      </div>
    </div>
         ...
         <div class="page-heading">
           <div class="login-page">
              <div class="form">
                ...
                <form class="login-form" action="crearcurso.php" method="POST">
                  <input maxlength="50" type="text" name="nombre" placeholder="Nombre del curso"/>
                  <input maxlength="255" type="text" name="descripcion" placeholder="Descripción del curso"/>
                  <p>
