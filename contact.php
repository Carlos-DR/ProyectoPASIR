...
<body>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-8 col-md-10 mx-auto">
        <p>¿Quieres ponerte en contacto con nosotros? Rellene el siguiente formulario para enviarme un mensaje y nos pondremos en contacto contigo lo antes posible.</p>
        <form name="sentMessage" novalidate action="contactar.php" method="POST">
