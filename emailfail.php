...
<body>
  ...
  <!-- Page Header -->
  <header class="masthead" style="background-image: url('img/registerfail.jpg')">
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-8 col-md-10 mx-auto">
        <p>El email introducido ya está registrado, por favor, pruebe con otro</p>
      </div>
    </div>
    <!-- Pager -->
      <div class="clearfix">
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-8 col-md-10 mx-auto">
        <p>Si se ha olvidado de la contraseña, por favor, haga clic en el botón de abajo</p>
      </div>
    </div>
    <!-- Pager -->
      <div class="clearfix">
        <a class="btn btn-primary float-right" href="contrasenia.php"> Recuperar contraseña &rarr;</a>
      </div>
      </div>
    </div>
    </div>
