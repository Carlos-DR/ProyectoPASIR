...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
    ...
    $consultapregunta = mysqli_query($conn, "SELECT id, pregunta FROM preguntas WHERE idexamen='$idexamen' AND correcta IS NULL AND id NOT IN (".implode(",",$pregcont).")");
  ...
  <!-- Page Header -->
  <header class="masthead" style="background-image: url('../../img/corregirexamen.jpg')">
    ...
    <div class="row">
      ...
      <!-- bucle para mostrar todos los cursos  -->
            ...
            <a>
                ...
                <div class="post-preview">
                    <form action="corregir.php" method="POST">
                        <div class="form-group">
                            <button type="submit" class="btn btn-primary" id="sendMessageButton" name="corregir" value="1">BIEN</button>
                        </div>
                    </form>
                </div>
                <!-- Botón Mal -->
                ...
                <form action="corregir.php" method="POST">
                <div class="form-group">
                    <button type="submit" class="btn btn-primary" id="sendMessageButton" name="corregir" value="0">MAL</button>
                </div>
                </form>
            </div> 
                <hr>
